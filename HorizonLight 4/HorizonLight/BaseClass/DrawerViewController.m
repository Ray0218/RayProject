...
@interface DrawerViewController ()<UIGestureRecognizerDelegate, DrawerTVCDelegate>
...
@property (nonatomic, strong) ClassificationViewController *classVC;
...
- (void)pushCtrlerWithNumber:(NSUInteger)number
{
    switch (number)
    {
        case 0:
        {
            self.mainTVC = [[MainTableViewController alloc] init];
            [UIView transitionFromView:self.mainVC.view toView:self.mainTVC.view duration:1.0 options:(UIViewAnimationOptionTransitionFlipFromRight) completion:nil];
        }
            break;
        case 1:
        {
            self.classVC = [[ClassificationViewController alloc] init];
            [UIView transitionFromView:self.mainVC.view toView:self.classVC.view duration:1.0 options:(UIViewAnimationOptionTransitionFlipFromRight) completion:nil];
        }
        ...
        case 2:
        {
            ...
            [UIView transitionFromView:self.mainVC.view toView:self.topTVC.view duration:1.0 options:(UIViewAnimationOptionTransitionFlipFromRight) completion:nil];
        }
