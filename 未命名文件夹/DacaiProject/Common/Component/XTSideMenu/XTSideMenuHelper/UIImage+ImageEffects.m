...
- (UIImage *)xt_applyLightEffect
{
    ...
    return [self xt_applyBlurWithRadius:30 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)xt_applyExtraLightEffect
{
    ...
    return [self xt_applyBlurWithRadius:20 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)xt_applyTintEffectWithColor:(UIColor *)tintColor
{
    ...
    return [self xt_applyBlurWithRadius:10 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
