...
//NS_ENUM(NSInteger, SVInfiniteViewState) {
//    SVInfiniteViewStateHidden = 0,
//    SVInfiniteViewStateLoading,
//    SVInfiniteViewStateFinished,
//};
...
@property (nonatomic, readwrite) SVActivityIndicatorViewStyle activityIndicatorViewStyle;
