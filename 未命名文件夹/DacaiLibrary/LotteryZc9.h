...
#ifndef __DacaiProject__LotteryZc9__
#define __DacaiProject__LotteryZc9__
...
class CLotteryZc9Target {
public:
    CLotteryZc9Target() : mIsMark(false) {
        memset(mBetOption, 0, sizeof(mBetOption));
        memset(mSpList, 0, sizeof(mSpList));
    }
...
public:
    ...
    vector<CLotteryZc9Target *> mTargets;
};

class CLotteryZc9 : public CModuleBase, public CNotify, public CProjectInfo {
...
protected:
    vector<CLotteryZc9Group *> mGroups;
    int mGroupId;
    int mMultiple;
...
#endif /* defined(__DacaiProject__LotteryZc__) */
