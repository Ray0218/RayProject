...
-(void)interrupt:(NSNotification*)notify{

    NSLog(@"=== essionWasInterrupted ===") ;
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(interrupt: ) name:AVCaptureSessionWasInterruptedNotification object:_captureSession];
