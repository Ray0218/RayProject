...
- (void)viewDidLoad
{
    ...
    // test line chart
    NSArray* plottingDataValues1 =@[@22, @33, @12, @23,@43, @32,@53, @33, @54,@55, @43, @23,@43, @33];
    NSArray* plottingDataValues2 =@[@24, @23, @22, @20,@53, @22,@33, @33, @54,@58, @43,@22, @33, @12,];

    self.lineChartView.max = 58;
    self.lineChartView.min = 12;
    
    
    self.lineChartView.interval = (self.lineChartView.max-self.lineChartView.min)/7;
    self.lineChartView.backgroundColor = [UIColor brownColor] ;
    ...
    self.lineChartView.numberOfVerticalElements = 7 ;//y轴数目
